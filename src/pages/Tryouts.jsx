  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="p-4 md:p-8 max-w-[1900px] mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-2 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
            Tryouts Board
          </h1>
          <p className="text-lg text-slate-600">Drag-and-drop team management with automatic rankings</p>
        </div>
        ...
        <Card className="border-none shadow-xl mb-6 bg-gradient-to-br from-white via-slate-50 to-blue-50">
          <CardContent className="p-4 md:p-6">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700 mb-2 block">Season</label>
