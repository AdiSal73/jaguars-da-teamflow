...
export default function LandingCTA() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* Sign Up Section */}
      <div className="py-24 bg-gradient-to-br from-emerald-600 via-gold-300 to-emerald-800">
      ...
      <div className="py-24 bg-slate-950 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <img 
            ...
            className="w-full h-full object-cover"
          />
        </div>        <div className="absolute inset-0 bg-gradient-to-b from-slate-400 via-slate-400/40 to-slate-400"></div>
