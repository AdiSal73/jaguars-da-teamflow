...
import {
  ...
  TrendingUp, Settings, Menu, X } from
"lucide-react";
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link to={createPageUrl("Analytics")} className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:block">
                <h1 className="font-bold text-slate-900 text-lg">Jaguars</h1>
                <p className="text-[10px] text-emerald-600 font-medium -mt-1">Player and Team Management</p>
              </div>
            </Link>
